...
// Source: github.com/VL-037/go-bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 db.TransferTxParams) (db.TransferTxResponse, error) {
	m.ctrl.T.Helper()
